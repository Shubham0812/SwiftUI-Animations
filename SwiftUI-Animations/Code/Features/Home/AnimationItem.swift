...
struct AnimationItem: Identifiable {
    ...
    static let all: [AnimationItem] = [
        ...
        AnimationItem(title: "Github Loader", systemIcon: "antenna.radiowaves.left.and.right", iconColor: Color.materialBlack, destination: .githubLoader, category: .loader),
        ...
        AnimationItem(title: "Octocat Wink", systemIcon: "eye.fill", iconColor: Color.materialBlack, destination: .octocat, category: .animation),
