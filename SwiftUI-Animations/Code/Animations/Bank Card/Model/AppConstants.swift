...
/// Static dummy data used to populate the Bank Card carousel demo.
///
/// Provides three sample `Card` instances and three `CardPalatte` color schemes
/// used across `CardView`, `CardFrontView`, and `CardBackView`.
struct AppConstants {
    /// Three sample cards with realistic-looking (fake) card numbers, balances, and palettes.
    static var cards = [
    ...
    /// Three gradient color pairs used as card background palettes (pink-blue, teal-navy, pink-yellow).
